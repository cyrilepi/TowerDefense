...
export class Level3 extends Phaser.Scene {
    ...
    preload() {
        this.load.tilemapTiledJSON('map', '../../Assets/Map/TroisiemeMap.tmj');
    }
    ...
    create() {
        ...
        const tilesetCasePlacement = map.addTilesetImage('iconTowerPlacement', 'towerPlacementCase');
        const tilesetCastlePurple = map.addTilesetImage('Castle_Purple', 'castlePurple');
        map.createLayer('Grass', tilesetSableEtHerbe);
        map.createLayer('EnemiesPath', tilesetMurEtEscalier);
        map.createLayer('Castle', tilesetCastlePurple);
        const layerCasePlacement = map.createLayer('towerCasePlacement', tilesetCasePlacement);
        ...
        this.waveManager.addWave('walkGoblinTntRed', 15, 1000, 0.05, 1);
